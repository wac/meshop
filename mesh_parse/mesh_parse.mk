...
mesh_parse: $(MESH_PREFIX)/mesh_ids.txt $(MESH_PREFIX)/mesh_tree.txt \
		...
		$(MESH_PREFIX)/load-mesh-ids.txt \
		$(MESH_PREFIX)/load-mesh-tree.txt
...
$(MESH_PREFIX)/load-mesh-ids.txt:	$(MESH_PARSE)/mesh_tables.sql $(MESH_PREFIX)/mesh_ids.txt 
...
$(MESH_PREFIX)/load-mesh-tree.txt:	$(MESH_PARSE)/mesh_tables.sql $(MESH_PREFIX)/mesh_tree.txt
	cat $(MESH_PARSE)/mesh_tables.sql | $(SQL_CMD) 
...
$(MESH_PREFIX)/mesh-child.txt:	$(MESH_PREFIX)/load-mesh-tree.txt $(MESH_PARSE)/mesh_child.sql
...
mesh_parse_clean:
	...
	rm -f $(MESH_PREFIX)/load-mesh-ids.txt 
	rm -f $(MESH_PREFIX)/load-mesh-tree.txt
